		...
		<div style="border-bottom: 1px solid black;">
			<table width="100%">
				<tr>
					...
					<td rowspan="2" class="week-retrospective__previous-week"><a href="#<?php echo $previous_week_retrospective_anchor; ?>">«</a></td>
					<td rowspan="2" class="week-retrospective__day-number"><a href="#<?php echo $week_overview_anchor; ?>"><?php echo $this->week_number; ?></a></td>
					<td rowspan="2" class="week-retrospective__next-week"><a href="<?php echo $next_week_retrospective_anchor; ?>">»</a></td>
					<td class="header-line week-retrospective__week-name_01"><?php echo $this->config->get( Config::WEEKLY_RETROSPECTIVE_TITLE_01 ); ?></td>
				</tr>
				<tr>
				<td class="week-retrospective__week-name_02"><?php echo $this->config->get( Config::WEEKLY_RETROSPECTIVE_TITLE_02 ); ?></td>
				</tr>
				<tr>
